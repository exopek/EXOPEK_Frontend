...
class HighlightsPlansPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<HighlightsPlansPage> createState() =>
      _HighlightsPlansPageState();
}
      ...
      data: (result) {
        return Scaffold(
          ...
          appBar: GenericAppBar.build(
              context, AppLocalizations.of(context).planHighlightsPageTitle),
          body: SizedBox(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Wrap(
                                    ...
                                    runSpacing: 8,
                                    children: [
                                      for (var hashtag in (result.plans[index]
