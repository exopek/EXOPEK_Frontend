...
class LightModeTheme extends ThemeBase {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
  ...
  late Color secondary = const Color(0xFFF83B46);
  late Color tertiary = const Color(0xFFFFFFFF);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryText = const Color(0xFF0F1212);
  late Color secondaryText = const Color(0xFF61666B);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFE0D8D8);
...
class DarkModeTheme extends ThemeBase {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
